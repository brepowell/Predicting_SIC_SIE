...
# THIS ASSUMES THAT YOU HAVE E3SM CLONED IN YOUR HOME DIRECTORY - WORKS!
# MAKE SURE TO SEARCH FOR [BLANK] AND FILL IN THE BLANKS

#!/bin/bash -fe

# E3SM Coupled Model Group run_e3sm script template.
# Copied from: https://github.com/E3SM-Project/E3SM/blob/75f1e8a503d9c8c63eb9a8f953e6128ea7a60375/run_e3sm.template.sh#L4
...
readonly PROJECT="[BLANK]" # CHANGED
...
readonly CASE_NAME="v3.LR.DTESTM.pm-cpu-[BLANK]"
# If this is part of a simulation campaign, ask your group lead about using a case_group label
# readonly CASE_GROUP=""

# Code and compilation
# BEFORE RUNNING: CHANGE CHECKOUT to date string like 20240301
#readonly CHECKOUT="latest" #CHANGED
#readonly BRANCH="master" #CHANGED
readonly CHERRY=( )
...
# Set paths
readonly CODE_ROOT="${HOME}/E3SM"   # CHANGED
readonly CASE_ROOT="/${SCRATCH}/E3SM_test_cases/${CASE_NAME}"  # CHANGED
...
if [ "${run}" != "production" ]; then
  ...
  echo "setting up ${run}" # Changed - added
  ...
  readonly STOP_N="40" # How often to stop the model, should be a multiple of REST_N
  readonly REST_OPTION="nyears"
  readonly REST_N="5" # How often to write a restart file
  readonly RESUBMIT="9" # Submissions after initial one
  readonly DO_SHORT_TERM_ARCHIVING=false
fi
...
# 400 YEARS: STOP_N="40" ; REST_N="5" (YEARS)  ; RESUBMIT="9"  = 40 + 9 * 40 = 400 YEARS!
...
do_fetch_code=false  # CHANGED - KEEP THIS OFF BECAUSE IT TRIES TO CLONE E3SM
